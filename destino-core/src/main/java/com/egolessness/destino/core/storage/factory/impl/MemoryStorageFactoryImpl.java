...
import com.egolessness.destino.core.storage.kv.MemoryStorage;
...
/**
 * memory implement of evanescent storage factory
 *
 * @author zsmjwk@outlook.com (wangkang)
 */
@Singleton
public final class MemoryStorageFactoryImpl implements EvanescentStorageFactory {
    ...
    @Override
    public <K> MemoryStorage<K, byte[]> create(Cosmos cosmos, Specifier<K, byte[]> specifier, StorageOptions options) {
        return new MemoryStorage<>(specifier::compare);
    }
