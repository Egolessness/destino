...
/**
 * request of update service
 *
 * @author zsmjwk@outlook.com (wangkang)
 */
@Body
@Http(value = "/api/service/{namespace}/{groupName}/{serviceName}", method = HttpMethod.PUT)
public class ServiceUpdateRequest extends ServiceRequest {

    private static final long serialVersionUID = 3308443834847003453L;

    public ServiceUpdateRequest(String namespace, String groupName, String serviceName) {
