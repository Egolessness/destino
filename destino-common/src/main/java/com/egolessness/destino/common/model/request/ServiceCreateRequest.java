...
/**
 * request of create service
 *
 * @author zsmjwk@outlook.com (wangkang)
 */
@Body
@Http(value = "/api/service", method = HttpMethod.POST)
public class ServiceCreateRequest extends ServiceRequest {

    private static final long serialVersionUID = -3587985812305006486L;

    public ServiceCreateRequest() {
    }

    public ServiceCreateRequest(String namespace, String groupName, String serviceName) {
