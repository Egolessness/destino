...
package com.egolessness.destino.common.annotation;
...
/**
 * annotation for http request {@link HttpRequestConverter}
 *
...
public @interface Http {
    ...
    String value() default DefaultConstants.RESTAPI_COMMON;
