...
/**
 * log parser for connect timeout.
 *
 * @author zsmjwk@outlook.com (wangkang)
 */
public class ConnectTimeoutLogParser implements LogParser {

    private static final String MSG_TEMPLATE = "Timeout occurred while sending execution plan to instance {0}.";

    private final String message;

    public ConnectTimeoutLogParser(InstancePacking packing) {
