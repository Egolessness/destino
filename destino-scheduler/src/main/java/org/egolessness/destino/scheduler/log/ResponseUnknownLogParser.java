...
/**
 * log parser for scheduled response unknown.
 *
 * @author zsmjwk@outlook.com (wangkang)
 */
public class ResponseUnknownLogParser implements LogParser {

    private static final String MSG_TEMPLATE = "The execution plan has been terminated because the response unknown from the instance {0}.";

    private final String message;

    public ResponseUnknownLogParser(InstancePacking packing) {
