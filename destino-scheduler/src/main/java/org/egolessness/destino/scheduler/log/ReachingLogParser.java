...
/**
 * log parser for sending execution.
 *
 * @author zsmjwk@outlook.com (wangkang)
 */
public class ReachingLogParser implements LogParser {

    private static final String MSG_TEMPLATE = "Attempting to send execution plan to the instance {0}.";

    private final String message;

    public ReachingLogParser(InstancePacking packing) {
