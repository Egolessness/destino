...
/**
 * log parser for busying forward.
 *
 * @author zsmjwk@outlook.com (wangkang)
 */
public class BusyingForwardLogParser implements LogParser {

    private static final String MSG_TEMPLATE = "The target instance {0} is in a busy state and is about to be forwarded to the next instance.";

    private final String message;

    public BusyingForwardLogParser(InstancePacking packing) {
