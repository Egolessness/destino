...
/**
 * log parser for execution is reached.
 *
 * @author zsmjwk@outlook.com (wangkang)
 */
public class ReachedLogParser implements LogParser {

    private static final String MSG_TEMPLATE = "The execution plan has been accepted by the instance {0}.";

    private final String message;

    public ReachedLogParser(InstancePacking packing) {
