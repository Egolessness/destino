...
public interface Addressing {
    ...
    void accept(Collection<InstancePacking> values);

    void lastDest(RegistrationKey dest, long executionTime);

    InstancePacking select();

    InstancePacking safetySelect();

    void clear();

    AddressingStrategy strategy();
