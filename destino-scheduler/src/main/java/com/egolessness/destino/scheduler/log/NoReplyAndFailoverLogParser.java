...
/**
 * log parser for client no reply and failover.
 *
 * @author zsmjwk@outlook.com (wangkang)
 */
public class NoReplyAndFailoverLogParser implements LogParser {

    private static final String MSG_TEMPLATE = "The execution plan did not receive a reply from instance {0} and is failing over to the next instance.";

    private final String message;

    public NoReplyAndFailoverLogParser(InstancePacking packing) {
