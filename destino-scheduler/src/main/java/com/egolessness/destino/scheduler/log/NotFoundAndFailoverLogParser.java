...
/**
 * log parser for client scheduled not found and failover.
 *
 * @author zsmjwk@outlook.com (wangkang)
 */
public class NotFoundAndFailoverLogParser implements LogParser {

    private static final String MSG_TEMPLATE = "The execution plan received a 'scheduled not found' reply from instance {0} and is failing over to the next instance.";

    private final String message;

    public NotFoundAndFailoverLogParser(InstancePacking packing) {
