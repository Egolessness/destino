...
/**
 * log parser for scheduled response failed and failover.
 *
 * @author zsmjwk@outlook.com (wangkang)
 */
public class ResponseFailedAndFailoverLogParser implements LogParser {

    private static final String MSG_TEMPLATE = "The execution plan received a failed response from instance {0} and is failing over to the next instance, code={1}, msg={2}.";

    private final String message;

    public ResponseFailedAndFailoverLogParser(InstancePacking packing, Response response) {
