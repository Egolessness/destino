...
/**
 * log parser for discarded.
 *
 * @author zsmjwk@outlook.com (wangkang)
 */
public class DiscardedLogParser implements LogParser {

    private static final String MSG_TEMPLATE = "The task has been discarded because the executor for instance {0} is currently in a blocked state.";

    private final String message;

    public DiscardedLogParser(InstancePacking packing) {
