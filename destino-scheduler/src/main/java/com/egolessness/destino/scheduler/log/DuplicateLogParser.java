...
/**
 * log parser for duplicate.
 *
 * @author zsmjwk@outlook.com (wangkang)
 */
public class DuplicateLogParser implements LogParser {

    private static final String MSG_TEMPLATE = "The execution plan already exists for instance {0}.";

    private final String message;

    public DuplicateLogParser(InstancePacking packing) {
