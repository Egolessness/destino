...
/**
 * addressing of first register instance.
 *
 * @author zsmjwk@outlook.com (wangkang)
 */
public class FirstAddressing extends AbstractAddressing {

    private List<InstancePacking> packingList;

    public FirstAddressing(ContainerFactory containerFactory, SchedulerInfo schedulerInfo) {
    ...
    public AddressingStrategy strategy() {
        return AddressingStrategy.FIRST;
    }
