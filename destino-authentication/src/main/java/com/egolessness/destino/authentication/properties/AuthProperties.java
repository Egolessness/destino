...
package com.egolessness.destino.authentication.properties;

import com.egolessness.destino.core.fixedness.PropertiesValue;

import static com.egolessness.destino.core.properties.constants.DefaultConstants.DEFAULT_SECURITY_SKIP_REGISTRATION;
import static com.egolessness.destino.core.properties.constants.DefaultConstants.DEFAULT_SECURITY_AUTH_SERVER_SECRET;
