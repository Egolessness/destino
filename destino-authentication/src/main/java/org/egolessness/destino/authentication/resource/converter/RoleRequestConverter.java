...
import org.egolessness.destino.authentication.model.request.RoleCreateRequest;
import org.egolessness.destino.authentication.model.request.RoleUpdateRequest;
...
/**
 * request converter of {@link RoleResource}.
 *
 * @author zsmjwk@outlook.com (wangkang)
 */
public class RoleRequestConverter implements RequestConverterFunction {
    ...
    public @Nullable Object convertRequest(@Nonnull ServiceRequestContext ctx,
        ...
        Object convertObj;
        if (expectedResultType == RoleCreateRequest.class) {
            convertObj = serializer.deserialize(httpRequest.content().array(), RoleCreateRequest.class);
        } else if (expectedResultType == RoleUpdateRequest.class) {
            convertObj = serializer.deserialize(httpRequest.content().array(), RoleUpdateRequest.class);
