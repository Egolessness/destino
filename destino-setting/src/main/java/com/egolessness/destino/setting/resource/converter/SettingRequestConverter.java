...
package com.egolessness.destino.setting.resource.converter;
...
import com.egolessness.destino.setting.resource.SettingResource;
...
/**
 * request converter of setting {@link SettingResource}
 *
 * @author zsmjwk@outlook.com (wangkang)
 */
public class SettingRequestConverter implements RequestConverterFunction {
    ...
    public @Nullable Object convertRequest(@Nonnull ServiceRequestContext ctx,
        ...
        Object convertObj;
        if (expectedResultType == SettingBatchUpdateRequest.class) {
            convertObj = serializer.deserialize(httpRequest.content().array(), SettingBatchUpdateRequest.class);
        } else if (expectedResultType == SettingUpdateRequest.class) {
            convertObj = serializer.deserialize(httpRequest.content().array(), SettingUpdateRequest.class);
        } else {
